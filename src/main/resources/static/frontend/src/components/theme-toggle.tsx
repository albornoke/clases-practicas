  ...
  return (
    <button
      ...
      className="relative flex items-center justify-center w-12 h-12 rounded-full shadow-lg transition-all duration-300 
        bg-gradient-to-tr from-yellow-400 via-white to-blue-400 
        dark:from-blue-900 dark:via-gray-900 dark:to-purple-900 
        hover:scale-110 border-2 border-primary/30"
